...
- **Missions & Free mode** — 15 best-practice challenges (tutorial / HA 3-tier / serverless / static CDN / async pipeline / container workload / global dynamic web / event-driven fan-out / security hardening / disaster recovery / data pipeline / secure auth web / zero-downtime ops / lean serverless / Well-Architected review) with 0–3 star ratings, or an open sandbox. Star grading is data-driven (`liveChain` structural matching over live edges); the Well-Architected capstone gates its stars on the live A–S grade badge (ADR 0067). 
...
└─ missions/               # 15 missions (+ data-driven custom missions): tutorial / 3-tier / serverless / static-CDN / async-pipeline / container / global-web / event-driven / security / disaster-recovery / data-pipeline / secure-auth-web / zero-downtime-ops / lean-serverless / well-architected-review
```
